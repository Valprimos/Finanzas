...
export function SplashScreen() {
  ...
  useEffect(() => {
    ...
    const salir = setTimeout(() => setFase("saliendo"), 650);
    const ocultar = setTimeout(() => setFase("oculto"), 950);
    return () => {
  ...
  return (
    <div
      aria-hidden="true"
      className={cn(
        "fixed inset-0 z-[100] flex items-center justify-center bg-[var(--background)] transition-opacity duration-300 ease-out",
